...
plot(dat2$Date_Time, dat2$Voltage, type="l", xlab="datetime", ylab="Voltage")
plot(dat2$Date_Time, dat2$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
